<?php 
	...
	echo do_shortcode('[woo_account_nav]'); 
?>	
...
<nav id="nav-below" class="navigation" role="navigation">
	<div class="nav-next alignright">
		<a href="<?php echo get_permalink( get_option('woocommerce_myaccount_page_id') ); ?>"><?php _e('View Your Membership Account &rarr;', 'paid-memberships-pro' );?></a>
	</div>

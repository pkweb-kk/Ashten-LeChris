	...
	<?php
		if(!$pmpro_confirm)
		{
			...
			<div class="pmpro_actionlinks">
				...
				<a class="pmpro_btn pmpro_btn-cancel pmpro_nolink nolink" href="<?php echo get_permalink( get_option('woocommerce_myaccount_page_id') ); ?>"><?php _e('No, keep this membership', 'paid-memberships-pro' );?></a>
			</div>
			<?php
			}
			else

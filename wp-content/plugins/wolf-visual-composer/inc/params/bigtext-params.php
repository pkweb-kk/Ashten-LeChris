	...
	return array(
		...
		'params' => array(
			...
			array(
				...
				'admin_label' => true,
				'description' => esc_html__( 'You can add several lines of text.', 'wolf-visual-composer' ) . '<br>' . sprintf( esc_html__( 'You can use the %s short tag to display the current page title.', 'wolf-visual-composer' ), '{{page_title}}' ),
			),
			...
			array(
				...
				'value' => apply_filters( 'wvc_default_big_text_font_weight', 700 ),
			),

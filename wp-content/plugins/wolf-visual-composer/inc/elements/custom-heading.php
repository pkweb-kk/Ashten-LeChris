	...
	array(
		...
		'params' => array(
			...
			array(
				...
				'admin_label' => true,
				'description' => sprintf( esc_html__( 'You can use the %s short tag to display the current page title.', 'wolf-visual-composer' ), '{{page_title}}' ),
			),
...
class WPBakeryShortCode_Wvc_Fittext extends WPBakeryShortCode {}
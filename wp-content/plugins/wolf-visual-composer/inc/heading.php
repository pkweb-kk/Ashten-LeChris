...
function wvc_heading( $atts ) {
	...
	$text_container_class .= ' wvc-custom-heading wvc-element';
	...
	$output .= ' style="' . wvc_esc_style_attr( $text_style ) . '" class="' . wvc_sanitize_html_classes( $class ) . '" data-max-font-size="' . absint( $font_size ) . '" data-min-font-size="' . absint( $min_font_size ) . '">';
	...
	$output .= wvc_sanitize_heading( do_shortcode( $text ) );

 ...
 * Register scripts
 *
 * @since Wolf WPBakery Page Builder Extension 2.7.4
 */
function wvc_register_scripts() {
	...
	*/
	...
	wp_register_script( 'flickity', WVC_JS . '/lib/flickity.pkgd.min.js', array( 'jquery' ), '2.0.5', true );
...
function wvc_overwrite_vc_scripts() {
	...
	wp_register_script( 'isotope', WVC_JS . '/lib/isotope.pkgd.min.js', array( 'jquery' ), '3.0.5', true );
}

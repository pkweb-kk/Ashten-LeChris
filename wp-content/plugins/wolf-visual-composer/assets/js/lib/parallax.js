...
;(function ( $, window, document, undefined ) {
	...
	function Parallax(element, options) {
		...
		//this.$mirror = $('<div />').prependTo( '#page' );
		...
		if (!sliderExisted)
			...
			//$( this.$slider[0] ).attr( 'data-src', this.imageSrc );
			this.$slider[0].src = this.imageSrc;

			// added srcset support
			if ( this.$element.data('image-srcset') ) {
				this.$slider[0].srcset = this.$element.data('image-srcset');
			}

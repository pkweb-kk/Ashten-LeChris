...
if ( $artist ) {
	...
	ob_start(); ?>
	<iframe src="https://www.bandsintown.com/artist/<?php echo esc_attr( $artist ); ?>/track_button?size=<?php echo esc_attr( $size ); ?>&display_tracker_count=true&text_color=%23FFFFFF&background_color=<?php echo urlencode( $background_color ); ?>&hover_color=<?php echo urlencode( $hover_color ); ?>" height="32" width="165" scrolling="no" frameborder="0" style="border:none; overflow:hidden; display:block;"; allowtransparency="true" ></iframe>
	<?php
	$output .= ob_get_clean();

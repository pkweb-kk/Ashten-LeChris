...
if ( 'none' !== $caption_position ) {
	$caption_html .= '<div class="wvc-iframe-opener-caption wow fadeIn" style="animation-delay:1600ms;-webkit-animation-delay:1600ms">';
...
if ( $custom_play_button && $button_image ) {
	...
	$img_class = 'wvc-iframe-custom-button-img wow fadeIn';
	$img_size = 'full';
